...
class MsisdnField(forms.Field):
    ...
    default_error_messages = { 
        ...
        'too_short': _(u'Enter a mobile number, consisting of minimum 11, maximum 12 digits eg: 27831234567'),
        'too_long': _(u'Enter a mobile number, consisting of minimum 11, maximum 12 digits eg: 27831234567'),
    }

    def __init__(self, default_country_code=None, restrict_country_code=None,
                 valid_prefixes=None, max_length=12, min_length=11, help_text='',
                 *args, **kwargs):
